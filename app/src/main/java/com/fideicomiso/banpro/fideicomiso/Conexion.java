...
public class Conexion extends SQLiteOpenHelper {
    ...
    public void crearTabla() {
        try {
            ...
            db.execSQL("CREATE TABLE IF NOT EXISTS 'registros' ('_id' INTEGER PRIMARY KEY AUTOINCREMENT, 'longitud' TEXT , 'latitud' TEXT ,'fecha' TEXT ,'ruta' TEXT , 'punto' INTEGER ,'usuario' INTEGER ,'estado' INTEGER DEFAULT  0  ,'comentario' TEXT , 'casa' TEXT , 'tipo' TEXT , 'cedula' TEXT );");
        } catch (Exception e) {
            Log.e("", e.toString());
        }
    }
